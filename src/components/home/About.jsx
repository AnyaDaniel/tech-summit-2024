...
const About = () => { 
  return (
    <section
      id="about"
      className="lg:px-40  pt-20  px-4  overflow-hidden  text-clip"
    >
      ...
      <div className="grid lg:grid-cols-3 grid-cols-1 gap-4 ">
        ...
        <div className="border border-[#DD0042]  flex flex-col justify-center gap-y-4 items-center bg-[#fff] lg:p-4 p-2">
        <p className="font-semibold lg:text-xl text-lg text-center">
            WHERE
          </p>
          <svg
          ...
          <p className="font-semibold lg:text-lg text-lg text-center">
