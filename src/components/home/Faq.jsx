...
const data = [
  {
    ...
    answer:
      "Attendance is open to all! Simply visit our Registration Page here to secure your spot. Don't miss out on this opportunity to connect with Black-owned businesses and industry leaders",
  },
  {
    question: " How do I become an exhibitor at the expo?",
    answer:
      "We welcome Black-owned businesses of all sizes to showcase their products and services. Head over to our Exhibitor Registration Page here secure your booth. Hurry, as spaces are limited!",
  },
  {
    question: "Are there sponsorship opportunities available?",
    answer:
      "Absolutely! We appreciate the support of our sponsors in making this event possible. If you're interested in becoming a sponsor, please reach out to our Sponsorship Team ",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes, we would love your support! If you're interested in volunteering, please fill out our Volunteer Application here. Your dedication helps us create a memorable and impactful event.",
  },
  {
  ...
  {
    question: "How can I contact the event organizers for additional questions?",
    answer:
